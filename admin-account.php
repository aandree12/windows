    ...
    <div class="main">
        <div class="main-left">
            ...
            <div class="buttons">
                ...
                <a data-bs-toggle='modal' data-bs-target='#modalThree' class='' href='#'><button class="logout-btn">оценить</button></a>
      ...
      <div class="modal-body">
        <?php
            ...
            <form action="vendor/mark-work.php" method="post" enctype='multipart/form-data'>
                    <select required name="get-user" id="">
                        <?php
                            require_once 'vendor/connect.php';

                            $getUser = mysqli_query($connect, "SELECT `fullname` FROM `users` WHERE `isadmin` = 0");
                            while($result = mysqli_fetch_array($getUser)) {
                                echo "
                    ...
                    <select required name="get-mark">
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
                        <option value="5">5</option>
                    </select>
                    <input required name='get-work-date' type="date">
