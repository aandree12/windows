...
<body>
    <div class="main">
        <div class="main-left">
            ...
            <div class="theme">
                <img src="img/day.png" class="change-theme-light" data-theme="light" alt="">
                <img src="img/night.png" class="change-theme-dark" data-theme="dark" alt="">
            </div>
            </div>
        </div>
                        ...
                        <?php
                            ...
                            while($result = mysqli_fetch_array($sql)) {
                              ...
                              <div class='works-wrapper'>
                                  <p class='student-work'> Работа {$result['user_fullname']} за {$result['work_date']} &nbsp; 
                                  <a download class='work-download' href='{$result['work_path']}'> скачать работу </a> &nbsp;
                                  <a data-bs-toggle='modal' data-bs-target='#modalThree' class='give-mark-btn work-download' href='#'>оценить</a> </p> 
                              </div>
                              ";
                            }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Оценка работы</h5>
      ...
      <div class="modal-body">
        <?php
            ...
            <form action="vendor/mark-work.php" method="post" enctype='multipart/form-data'>
                <input type="text" name="user_fullname" class="fullname-input" placeholder="Введите ФИО ученика">
                <input type="text" name="work_date" class="fullname-input" placeholder="Введите дату загрузки работы">
                <input type="text" name="work_mark" class="fullname-input" placeholder="Введите оценку">
                <input type="submit" value="Оценить" class="btn-primary download-submit mt-3">
            </form>
      </div>
